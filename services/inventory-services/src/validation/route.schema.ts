...
export type CreateRouteBody = z.infer<
  typeof createRouteSchema
>;

export type UpdateRouteBody = z.infer<
  typeof updateRouteSchema
>;

export type RouteIdParams = z.infer<
  typeof routeIdParamsSchema
>;

export type SearchRoutesQuery = z.infer<
  typeof searchRoutesQuerySchema
>;